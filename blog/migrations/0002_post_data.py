...
POSTS = [
    {
      "title": "Django 1.11.5 Release",
        "slug": "django-1-11-5-released",
        "pub_date": date(2017, 8, 5),
        "startups": [],
    ...
    },
{
    ...
    {
        "title": "Django 1.10 Release",
        "slug": "django-1-10-released",
        "pub_date": date(2016, 4, 1),
        "startups": [],
        "tags": ["django", "python", "web"],
        "text": "Django 1.10 is Django's newest "
            "version, and the next version "
            "slated for Long-Term Support "
            "(LTS). LTS means that Django 1.10 "
